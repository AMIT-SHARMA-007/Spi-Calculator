 ...
 */
public class Ic5 extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ic5);
        subjects = new Spinner[10];
        ...
        subjects[8] = (Spinner)findViewById(R.id.select_grade_9);
        subjects[9] = (Spinner)findViewById(R.id.select_grade_10);
        credits = new int[]{3,4,4,4,1,1,4,4,4,4};
        ...
        subjects[8].setAdapter(dataAdapterGrades);
        subjects[9].setAdapter(dataAdapterGrades);
